...
```{ r}
packages <- c('ggplot2','dplyr','zoo','lubridate','readr')
...
dataURL <- 'https://d396qusza40orc.cloudfront.net/'
if (!fileexists('repdata%2Fdata%2FStormData.csv.bz2')) {
  download(dataURL,destfile = zipfile,mode='wb',quiet=FALSE)
